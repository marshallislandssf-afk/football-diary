...
export default function SettingsPage() {
  ...
  const profileUrl = username
    ? (typeof window !== 'undefined' ? window.location.origin : 'https://football-diary.vercel.app') + '/u/' + username
    : '';
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-8 space-y-5">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <input
                  ...
                  className="flex-1 min-w-[120px] bg-[#161b22] border border-[#30363d] rounded-lg px-3 py-2 text-sm text-[#e6edf3] focus:outline-none focus:border-[#58a6ff] placeholder-[#484f58]"
                />
              </div>
          ...
          {isPublic && username && (
            <div className="mt-3 space-y-2">
              <div className="flex items-center gap-2 bg-[#161b22] border border-[#3fb950]/30 rounded-lg px-3 py-2">
                ...
                <button
                  onClick={handleCopy}
                  className="flex items-center gap-1.5 text-xs text-[#3fb950] hover:text-[#2ea043] flex-shrink-0 border border-[#3fb950]/30 rounded px-2 py-1"
                >
              ...
              <p className="text-[11px] text-[#484f58]">
                Share this link — anyone can view your matches without an account.
              </p>
            </div>
          )}
        ...
        {error && (
          <p className="text-xs text-[#f85149] bg-[#f85149]/10 border border-[#f85149]/20 rounded-lg px-3 py-2">{error}</p>
        )}
        {success && (
          <p className="text-xs text-[#3fb950] bg-[#3fb950]/10 border border-[#3fb950]/20 rounded-lg px-3 py-2">{success}</p>
        )}
