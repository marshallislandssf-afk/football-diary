...
export function EditMatchModal({ match, onSave, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-[#1c2128] border border-[#30363d] rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            <label className="block text-xs font-medium text-[#8b949e] mb-2">Annotations</label>
